...
class SwiftSSLTests: XCTestCase {
    ...
    func testDigest_SHA512() {
        let digest = plainText.digest(SwiftSSL.DigestAlgorithm.SHA512)
    ...
    */
    ...
    func testHMAC_SHA512() {
        let signature = plainText.sign(SwiftSSL.HMACAlgorithm.SHA512, key: key)
